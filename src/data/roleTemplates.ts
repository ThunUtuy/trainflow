    ...
    modules: [
      {
        ...
        pages: [
          { type: "image", title: "First Impressions", content: { text: "Your appearance sets the tone before you speak. Clean, neat, and professional — always.", url: firstImpressionsImg } },
          ...
          { type: "image", title: "Personal Hygiene", content: { text: "Short clean nails, no polish. Hair tied back. Minimal jewellery. Deodorant, no strong fragrance.", url: personalHygieneImg } },
          ...
          { type: "image", title: "Feeling Unwell?", content: { text: "Vomiting, diarrhoea, or fever? Stay home. You must be symptom-free for 48 hours before returning.", url: feelingUnwellImg } },
      ...
      },
      {
        ...
        pages: [
          { type: "image", title: "The 10/5 Rule", content: { text: "At 10 feet — smile and make eye contact. At 5 feet — greet them warmly.", url: tenFiveRuleImg } },
          ...
          { type: "image", title: "Anticipate Needs", content: { text: "Empty glass? Dropped napkin? Confused look? Act before the guest asks. That's great service.", url: anticipateNeedsImg } },
          { type: "image", title: "Positive Language", content: { text: "Say 'Absolutely!' not 'No problem.' Say 'Great choice!' not 'OK.' Words matter.", url: positiveLanguageImg } },
          { type: "image", title: "Always Ask About Allergies", content: { text: "\"Does anyone have allergies or dietary requirements?\" If unsure about ingredients, check with the kitchen.", url: askAllergiesImg } },
          { type: "image", title: "Checking on the guest", content: { text: "Check on your table approximately two minutes after the food has been delivered, or after they have had a chance to take about two bites.", url: checkingOnGuestImg } },
      ...
      },
      {
        ...
        pages: [
          { type: "image", title: "The First 30 Seconds", content: { text: "A guest's first impression is set in 30 seconds. Acknowledge them immediately, even if busy.", url: first30SecondsImg } },
          ...
          { type: "image", title: "Seating Guests", content: { text: "Walk at their pace. Pull out chairs for elderly guests. Present menus and introduce their server.", url: seatingGuestsImg } },
          { type: "image", title: "Managing a Wait", content: { text: "Give a specific time: '15 minutes' beats 'not too long.' Take their name and text when ready.", url: managingWaitImg } },
          { type: "image", title: "Reservations", content: { text: "Check the book at the start of every shift. Note VIPs, allergies, and celebrations.", url: reservationsImg } },
      ...
      },
      {
        ...
        pages: [
          { type: "image", title: "Know the Menu", content: { text: "Every dish, every ingredient, every allergen. If you can't describe it, you can't sell it.", url: knowMenuImg } },
          { type: "image", title: "Taking Orders Right", content: { text: "Use seat numbers. Write everything down. Read the order back to confirm. Never rely on memory.", url: takingOrdersImg } },
          { type: "image", title: "Upselling Done Right", content: { text: "Be specific: 'Our sea bass is incredible tonight' beats 'Want a starter?' Read the table first.", url: upsellingImg } },
          { type: "image", title: "Specials", content: { text: "Memorise daily specials before service. Describe flavours, not just ingredients.", url: specialsImg } },
      ...
      },
      {
        ...
        pages: [
          { type: "image", title: "Complaints = Opportunities", content: { text: "A well-handled complaint turns a frustrated guest into a loyal regular. Don't fear it.", url: complaintsOpportunitiesImg } },
          { type: "image", title: "L — Listen", content: { text: "Let the guest speak. Don't interrupt. Maintain eye contact and nod to show you're engaged.", url: listenImg } },
          { type: "image", title: "A — Apologise", content: { text: "\"I'm sorry about that. That's not the experience we want for you.\" Don't blame others.", url: apologiseImg } },
          { type: "image", title: "S — Solve", content: { text: "Offer a fix: remake the dish, remove it from the bill. Unsure? Ask your manager.", url: solveImg } },
          { type: "image", title: "T — Thank", content: { text: "\"Thank you for telling us — it helps us improve.\" Follow up before they leave.", url: thankImg } },
      ...
      },
      {
        ...
        pages: [
          ...
          { type: "image", title: "Logging In", content: { text: "Use your own PIN. Never share it. All actions are tracked under your ID.", url: posLoginImg } },
          { type: "image", title: "Entering Orders", content: { text: "Select correct table → add items by seat → note modifications → double-check → send to kitchen.", url: enteringOrdersImg } },
          { type: "image", title: "Taking Payment", content: { text: "Present the bill. Bring the card machine. Wait for 'Approved.' If declined, be discreet.", url: takingPaymentImg } },
          { type: "image", title: "Voids & Discounts", content: { text: "Always need manager approval. Never void a served item without asking first.", url: voidsDiscountsImg } },
